...
namespace ResumeApp.WebApi.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ExperienceSqlEntitySkillSqlEntity",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExperienceSqlEntitySkillSqlEntity", x => new { x.ExperiencesId, x.SkillsId });
                    table.ForeignKey(
                        name: "FK_ExperienceSqlEntitySkillSqlEntity_Experiences_ExperiencesId",
                        column: x => x.ExperiencesId,
                        principalTable: "Experiences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExperienceSqlEntitySkillSqlEntity_Skills_SkillsId",
                        column: x => x.SkillsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExperienceSqlEntitySkillSqlEntity_SkillsId",
                table: "ExperienceSqlEntitySkillSqlEntity",
                column: "SkillsId");
        }
